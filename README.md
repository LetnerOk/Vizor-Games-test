...
Retention по когортам пользователей, установивших приложение с 2020-10-05 по 2020-10-14 показывает стабильные значения. Retention 7-ого дня для шести дней установки выше 20%, что говорит о хорошем удержании пользователей. 
